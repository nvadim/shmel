                                ...
                                <div class="move_step move_step-active loaders_step">
                                    ...
                                    <div class="move_step3__item move_config">
                                        ...
                                        <div class="move_config__content">
                                            ...
                                            <div class="rigging_one__wrap move_step3__item-transport move_config">
                                                <div class="move_config__head">
                                                    <div class="move_config__left">
                                    ...
                                    <div class="move_step__buttons move_step1__buttons">
                                        <button class="move_step__btn btn btn-white" type="button" onClick='location.href="/"'>Вызвать замерщика?</button>
                                        <button class="move_step__btn btn btn-white" type="button" onClick='location.href="/"'>+ Добавить адрес</button>
