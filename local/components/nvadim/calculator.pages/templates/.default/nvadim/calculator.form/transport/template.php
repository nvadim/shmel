                ...
                <div class="move_step3__item move_config">
                    <div class="move_config__head">
                        ...
                        <div class="move_config__right">
                            <button class="btn btn-white" type="button" onClick='location.href="./move_step3_1s.html"'>Откорректировать вручную</button>
                        </div>
                    </div>
                    <div class="move_config__content">
                        <div class="default_content">
                            <div class="default_content__left">
                                <div class="default_content__pic"><img src="img/1-cat-1.svg" alt="" class="default_content__img"></div>
                                <div class="default_content__desc">
                                    ...
                                    <div class="default_content__pass pass">
                                        <img src="img/propusk.svg" alt="" class="pass__img">
