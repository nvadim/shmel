    ...
    <div class="move_page__nav_wrap">
        <div class="move_page__nav_box move_nav">
            <div class="move_nav__wrap box">
                <a href="/move/route/?move_type=apartment" class="move_nav__item">
                ...
                <a href="/move/route/?move_type=office" class="move_nav__item">
                    <span class="move_nav__pic">
                ...
                <a href="/move/route/?move_type=village" class="move_nav__item">
                    <span class="move_nav__pic">
