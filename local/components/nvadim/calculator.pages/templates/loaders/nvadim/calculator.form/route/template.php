    ...
    <form action="<?=$APPLICATION->GetCurPageParam() ?>" name="calc_form" method="POST" class="move_calc__form">
        ...
        <div class="move_step move_step-active move_step1">
            <div class="move_step1__service service">
                ...
                <div class="service">
                    <p class="additionally__title additionally__title-mt">Вы можете выбрать одну или несколько услуг одновременно</p>

                    <div class="checked">
                        <div class="checked__list">
                            <div class="checked__item service__item">
                                <input type="radio"
                                    <?= ($arResult['type']=='loading')?'checked':''?>
                                       class="checked__radio service__radio"
                                       name="<?= $arParams['STEP']?>[TYPE]"
                                       value="loading"
                                       id="service1">
                            ...
                            <div class="checked__item service__item">
                                <input type="radio"
                                    <?= ($arResult['type']=='assembly')?'checked':''?>
                                       class="checked__radio service__radio"
                                       name="<?= $arParams['STEP']?>[TYPE]"
                                       value="assembly"
                                       id="service2">
