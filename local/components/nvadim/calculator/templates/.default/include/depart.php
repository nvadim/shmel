<div class="move_step move_step-active move_step3">
                ...
                <div class="move_config__wrap">
                    <div class="min_input">
                        <div class="min_input__one">
                            ...
                            <div class="min_input__one_box"><input name="<?= $arResult['suffix_form_name']?>[FLOOR]" type="number" class="min_input__input" onkeypress="return enterNumber(event);"></div>
                        </div>
                        <div class="min_input__one">
                            <p class="rooms_info__title">
                            ...
                            <div class="min_input__one_box"><input name="<?= $arResult['suffix_form_name']?>[AREA]" type="number" class="min_input__input" onkeypress="return enterNumber(event);"></div>
                        </div>
                        <div class="min_input__one">
                            <p class="rooms_info__title">
                            ...
                            <div class="min_input__one_box"><input name="<?= $arResult['suffix_form_name']?>[QUANTITY_ROOMS]" type="number" class="min_input__input" onkeypress="return enterNumber(event);"></div>
                        </div>
                    </div>
                </div>
                <div class="move_config__wrap">
                                        ...
                                        <div class="checked__list checked__list-rigger">
                                            <? foreach ($arResult['rigging_list'] as $rigging) {?>
                                                <div class="checked__item checked__item-rigging">
                                                    <input type="checkbox" class="checked__radio" name="rigging" value="<?= $rigging->StructTermsOfRigging->ID?>" id="<?= $rigging->StructTermsOfRigging->ID ?>" onchange="checkHiddenBox(this)" data-check-hidden="id1">
    ...
    <div class="move_step__buttons move_step1__buttons">
        ...
        <button class="move_step__btn btn btn-white" type="button" onClick='location.href="./move_step1_1.html"'>Редактировать адреса</button>
        <button class="move_step__btn btn" type="button" onClick='location.href="./move_step2_2.html"'>Далее</button>
    </div>
</div>