...
<div class="move_step move_step-active move_step1">
    ...
    <div class="move_step2__mapping ">
        <div class="mapping">
            <div class="mapping__one">
                ...
                <input type="text"
                       class="mapping__input"
                       name="ROUTE_PAGE[FROM][]"
                       required=""
            ...
            <!--<div class="mapping__one">
                ...
                <input type="text"
                       class="mapping__input"
                       placeholder="Москва, ул. Яблочкова д.18 к.3">
                <button class="mapping__delete"
                        type="button">Удалить
                </button>
            </div>-->
            <div class="mapping__one">
                ...
                <button class="mapping__add btn btn-white"
        ...
        <div class="button_map">
            <button class="button_map__btn"
                    type="button"
                    data-modal="#auth"
                    data-url="<?= FRONEND_BUILD_PATH?>/map.html">
                <span class="button_map__ico"><img
                        src="<?=FRONEND_BUILD_PATH?>img/gps.svg"
                        class="button_map__img"></span>
            ...
            <div class="form">
                ...
                <div class="form__row step__form_pt">
                    <div class="form__one form__one-w100">
                        ...
                        <textarea
                            class="form__element form__element-input"
                            name="ROUTE_PAGE[CONTACT][COMMENT]"
                            cols="30"
                            rows="5"></textarea>
                        </div>
                    </div>
        ...
        <div class="check_inline">
            <div class="check_inline__one">
                <input type="checkbox"
                       ...
                       name="ROUTE_PAGE[USE_CONTACT_FOR_ALL]"
                       value="Y"
                       id="radio_0" checked>
                <label for="radio_0"
    ...
    <div class="move_step__buttons move_step1__buttons">
        ...
        <input class="move_step__btn btn" type="submit" value="Далее" name="submit_form">
    </div>
</div>
