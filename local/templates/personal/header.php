        ...
        <div class="text_page">
            <div class="text_page__wrap box">
                <div class="personal_box">
                    <div class="personal_box__wrap">
                        <div class="personal_box__content">
                            <p class="personal_box__title title title-left title-left_orange"><?=$APPLICATION->AddBufferContent('ShowTitleOrHeaderFooter')?></p>
