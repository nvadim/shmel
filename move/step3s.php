                        ...
                        <span class="mapping__point_box">
                            <span class="mapping__point mapping__point-finish">3</span>
												...
												<div class="mapping__one">
													...
													<div class="mapping__address">
														<button class="btn btn-white move_step__btn" type="button" onClick='location.href="./step2.php"'>Редактировать адреса</button>
													</div>
												</div>
											</div>
										</div>
											...
											<div class="move_config__head">
												<div class="move_config__left">
													<p class="move_config__spoiler_title move_config__spoiler_title-custom">Транспорт:
														<button class="move_config__btn_default btn btn-white" type="button">Вернуть рекомендуемые значения</button>
													</p>
												</div>
												<div class="move_config__right">
													<button class="move_config__spoiler" type="button">Свернуть</button>
										...
										<div class="move_step3__item move_step3__item-transport move_config" id="qw5">
											<div class="move_config__head">
												<div class="move_config__left">
                                        ...
                                        <span class="times_day__pic">
                                            ...
                                            <span class="times_day__text_one times_day__text_one-small">16:00–9:00</span>
												...
												<div class="stevedores">
													<button class="stevedores_btn btn">+ Добавить грузчиков другой квалификации</button>
												</div>
												<div class="total_transport">
										...
										<div class="move_step3__item move_step3__item-transport move_config" id="qw6">
											<div class="move_config__head">
												<div class="move_config__left">
													<p class="move_config__spoiler_title move_config__spoiler_title-custom">Упаковка:
														<button class="move_config__btn_default btn btn-white" type="button">Вернуть рекомендуемые значения</button>
													</p>
												</div>
												<div class="move_config__right">
											...
											<div class="move_config__content">
															...
															<div class="packaging__item packaging__item-line">
																<div class="packaging__tt packaging__n">
																	<div class="packaging__goods_info">
																		<div class="packaging__pic"><img src="/local/test/img/pic.jpg" alt="" class="packaging__img"></div>
												...
												<div class="stevedores">
													<button class="stevedores_btn btn" data-modal="#catalog" data-url="/local/test/catalog.html">+ Добавить упаковку и другие товары для переезда</button>
												</div>
											</div>
										</div>
										<div class="move_config__no_hidden move_config__no_hidden-green">
									...
									<div class="move_step__buttons move_step1__buttons">
										<div class="total_buttons">
											<p class="total_buttons__text">Общая стоимость переезда:</p>
											<p class="total_buttons__price">39 985 ₽</p>
										</div>
										<button class="move_step__btn move_step__btn-last_step btn" type="button" onClick='location.href="./step4.php"'>Оформить заказ</button>
									</div>
								</div>
							</form>
						</div>
