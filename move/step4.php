							...
							<form action="" method="get" class="move_calc__form">
								<div class="nav_step">
									<div class="nav_step__line">
										<div class="nav_step__line_orange nav_step__line_orange-step4"></div>
									</div>
										...
										<div class="move_step4__personal">
											...
											<div class="personal_edit__password_box form">
												...
												<div class="form__one form__one-left form__one-big">
													...
													<div class="form__element_box">
														<div class="form__pass_box">
															<input type="text" id="id2" value="" class="form__element form__element-input">
														</div>
													</div>
												</div>
												<div class="form__one form__one-left form__one-big">
											...
											<div class="choice_payment">
												<div class="choice_payment__item">
													...
													<div class="choice_payment__button">
														<button class="btn choice_payment__btn" type="button" onClick='location.href="./step5.php"'>Выбрать рекомендованный переезд</button>
													</div>
												</div>
												<div class="choice_payment__item">
													...
													<div class="choice_payment__button">
														<button class="btn choice_payment__btn" type="button" onClick='location.href="./step5.php"'>Выбрать ваш настроенный переезд</button>
													</div>
												</div>
											</div>
