                                        ...
                                        <div class="move_config__no_hidden move_config__no_hidden-green choice_payment_box">
                                            <div class="choice_payment">
                                                <div class="choice_payment__item">
                                                    <p class="choice_payment__desc">Сумма заказа:</p>
                                                    <p class="choice_payment__price">29 985 ₽</p>
                                                    <div class="choice_payment__button">
                                                        <button class="btn choice_payment__btn" type="button" onClick='location.href="/transport/step3.php"'>Оформить заказ</button>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="navigator">
                            ...
                            <div class="navigator__list">
                                <div class="navigator__item">
                                    ...
                                    <button class="navigator__link" data-scroll="#" type="button">Маршрут 1</button>
                                </div>
                                <div class="navigator__item">
                                    <span class="navigator__icon"><i class="navigator__i"></i></span>
                                    <button class="navigator__link" data-scroll="#" type="button">Транспорт <span class="navigator__price">4000 ₽</span></button>
                                </div>
                                <div class="navigator__item">
                                    <span class="navigator__icon"><i class="navigator__i"></i></span>
                                    <button class="navigator__link" data-scroll="#" type="button">Грузчики <span class="navigator__price">2000 ₽</span></button>
                                </div>
                            </div>
                            <p class="navigator__total">Итого: <span class="navigator__total_price">39 985 ₽</span></p>
                            <div class="navigator__buttons">
                                <button class="navigator__btn btn btn-white" type="button" onClick='location.href="/transport/step1.php"'>Редактировать</button>
                                <button class="navigator__btn btn" type="button" onClick='location.href="/transport/step3.php"'>Оформить заказ</button>
                            </div>
                        </div>
                    </div>
                </div>
